...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_shixiezhu1=Rect(2720.0, 18944.0, 3040.0, 19168.0)
    set gg_rct_shixiezhu2=Rect(1824.0, 17312.0, 3968.0, 19552.0)
    set gg_rct_shaohuogun=Rect(5216.0, 18080.0, 5536.0, 18304.0)
    set gg_rct_shaohuogun1=Rect(5216.0, 18944.0, 5536.0, 19168.0)
    ...
    set gg_rct_lgfnpc13=Rect(1312.0, 4320.0, 1472.0, 4512.0)
    ...
    set gg_rct_lgfnpc23=Rect(4032.0, 4320.0, 4192.0, 4512.0)
    ...
    set gg_rct_lgfnpc33=Rect(6656.0, 4320.0, 6816.0, 4512.0)
    ...
    set gg_rct_lgfnpc43=Rect(1312.0, 1472.0, 1472.0, 1664.0)
    ...
    set gg_rct_lgfnpc53=Rect(4000.0, 1504.0, 4160.0, 1696.0)
    ...
    set gg_rct_lgfnpc63=Rect(6688.0, 1504.0, 6848.0, 1696.0)
    ...
    set gg_rct_sylz1=Rect(10592.0, 28352.0, 10880.0, 28640.0)
    set gg_rct_sylz=Rect(10592.0, 27648.0, 10880.0, 27936.0)
