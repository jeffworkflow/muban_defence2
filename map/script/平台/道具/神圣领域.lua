...
['全伤加深系数'] = function(self)
    ...
    return p:Map_GetMapLevel()*1
end,
need_map_level = 1,
--特效
effect = [[linghunguanghuan.mdx]]
}

for i,name in ipairs({'血色领域','血雾领域','龙腾领域','迦蓝领域','极寒领域','黄龙天翔领域','焚魂镇妖领域','真武青焰领域','琉光十色领域','孤风青龙领域','远影苍龙领域'}) do
