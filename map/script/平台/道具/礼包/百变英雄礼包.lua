...
|cff00ff00额外赠送5只精美英雄皮肤（赠送皮肤非固定皮肤，可能随时变更，在 “最强魔灵-英雄皮肤-下一页” 查看）
...
|cffdf19d0百变英雄礼包+独孤求败（在 “最强魔灵-称号” 内查看获得方式），激活额外属性：
...
--说明
tip = [[
|cff00ff00点击获得|cffffff00吞噬丹+2，恶魔果实+2，点金石+20|r，|cff00ff00其它属性在 |cff00ffff“最强魔灵-礼包” |cff00ff00中查看
]],
attr_tip = '',
--目标类型
target_type = ac.skill.TARGET_TYPE_NONE,
