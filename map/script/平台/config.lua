...
local cus_key = {
    ...
    {'symxjl','深渊冒险奖励',{
        --奖励  所需值 地图等级
            ...
            ['深渊三层'] = {4,7,rate = 16, type = '二进制权限'},
            ['深渊四层'] = {5,8,rate = 14, type = '二进制权限'},
            ['深渊五层'] = {6,9,rate = 12, type = '二进制权限'},
            ['深渊六层'] = {7,10,rate = 10, type = '二进制权限'},
            ['深渊七层'] = {8,11,rate = 8, type = '二进制权限'},
            ['深渊八层'] = {9,12,rate = 6, type = '二进制权限'},
            ['深渊九层'] = {10,13,rate = 4, type = '二进制权限'},
            ['深渊十层'] = {11,14,rate = 2, type = '二进制权限'},
        }
    },
    ...
    {'sxseh','生肖十二魂',{
            ...
            ['虎灵法袍'] = {13,6,rate = 100, type = '二进制权限'},
            ['虎灵头束'] = {14,6,rate = 100, type = '二进制权限'},
            ['虎灵浮尘'] = {15,6,rate = 100, type = '二进制权限'},
            ['虎灵宝镜'] = {16,6,rate = 100, type = '二进制权限'},
