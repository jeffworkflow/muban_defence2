...
|cffcccccc杀死【鼠天瞳】获得，需要地图等级大于|cffffff003]],
...
|cffcccccc杀死【牛金刚】获得，需要地图等级大于|cffffff006]],
...
|cffcccccc杀死【鼠天瞳】获得，需要地图等级大于|cffffff006]],
...
|cffcccccc杀死【武伯都】获得，需要地图等级大于|cffffff009]],
...
|cffcccccc杀死【武伯度】获得，需要地图等级大于|cffffff009]],
...
|cffcccccc杀死【兔飞】获得，需要地图等级大于|cffffff0011]],
...
|cffcccccc杀死【辰龙】获得，需要地图等级大于|cffffff0013]],
...
|cffcccccc杀死【紫】获得，需要地图等级大于|cffffff0015]],
...
|cffcccccc杀死【马不凡】获得，需要地图等级大于|cffffff0017]],
...
点击查看 |cff00ffff虎灵|r 成就，通过挑战|cff00ff00【武伯都】|r获得
 ]],
...
点击查看 |cff00ffff马灵|r 成就，通过挑战|cff00ff00【马不凡】|r获得

集齐|cffffff005件套装|r可获得额外属性：
|cff00ff00+688 每秒加攻击 
+688 攻击加全属性 
+50% 暴击伤害
+25% 技暴伤害
...
mt.skills = {
    '马灵战盔','马灵战铠','马灵战肩','马灵战腿','马灵战腰','马灵战手','马灵战腕','马灵战靴','马灵战斧'
}
function mt:on_add()
    ...
    ac.wait(0,function()
        ...
        for index=1,table.maxnum(self.skill_book) do 
            ...
            if skl and skl.level >=1 then 
                ...
                if cnt == 6 then 
                    self.owner:add_skill('马灵5件套','隐藏')
                end
                if cnt == #self.skills then 
                    self.owner:add_skill('马灵全套','隐藏')
                end
            end
        end
    end)
