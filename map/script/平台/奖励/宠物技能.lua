...
local peon_skill = {
    ...
    ['宠物-杀敌数加成'] = {'杀敌数加成','杀敌数加成',5,[[cwjnxx.blp]],[[|n|cffFFE799【使用说明】：|r|n|cff00ff00点击可升级，每级提升5%，当前杀敌数加成 +%杀敌数加成%|cff00ff00 %|r|n|n]]},
    ['宠物-木头加成'] = {'木头加成','木头加成',5,[[cwjnxx.blp]],[[|n|cffFFE799【使用说明】：|r|n|cff00ff00点击可升级，每级提升5%，当前木头加成 +%木头加成%|cff00ff00 %|r|n|n]]},
    ['宠物-物品获取率加成'] = {'物品获取率加成','物品获取率',5,[[cwjnxx.blp]],[[|n|cffFFE799【使用说明】：|r|n|cff00ff00点击可升级，每级提升5%，当前物品获取率加成 +%物品获取率%|cff00ff00 %|r|n|n]]},
    ['宠物-魔丸加成'] = {'魔丸加成','魔丸加成',5,[[cwjnxx.blp]],[[|n|cffFFE799【使用说明】：|r|n|cff00ff00点击可升级，每级提升5%，当前魔丸加成 +%魔丸加成%|cff00ff00 %|r|n|n]]},
    ['宠物-分裂伤害加成'] = {'分裂伤害加成','分裂伤害',8,[[cwjnxx.blp]],[[|n|cffFFE799【使用说明】：|r|n|cff00ff00点击可升级，每级提升5%，当前分裂伤害加成 +%分裂伤害%|cff00ff00 %|r|n|n]]},
    ['宠物-攻击速度加成'] = {'攻击速度加成','攻击速度',8,[[cwjnxx.blp]],[[|n|cffFFE799【使用说明】：|r|n|cff00ff00点击可升级，每级提升5%，当前攻击速度加成 +%攻击速度%|cff00ff00 %|r|n|n]]},
    ['宠物-杀怪力量成长'] = {'攻击减甲加成','攻击减甲',8,[[cwjnxx.blp]],[[|n|cffFFE799【使用说明】：|r|n|cff00ff00点击可升级，每级提升4，当前攻击减甲 +%攻击减甲%|cff00ff00|r|n|n]]},
    ['宠物-杀怪敏捷成长'] = {'减少周围护甲加成','减少周围护甲',100,[[cwjnxx.blp]],[[|n|cffFFE799【使用说明】：|r|n|cff00ff00点击可升级，每级提升50，当前减少周围护甲 +%减少周围护甲%|cff00ff00|r|n|n]]},
    ['宠物-杀怪智力成长'] = {'每秒护甲成长','每秒加护甲',1,[[cwjnxx.blp]],[[|n|cffFFE799【使用说明】：|r|n|cff00ff00点击可升级，每级提升1，当前每秒加护甲 +%每秒加护甲%|cff00ff00|r|n|n]]},
    ['宠物-杀怪全属性成长'] = {'杀怪全属性成长','杀怪加全属性',25,[[cwjnxx.blp]],[[|n|cffFFE799【使用说明】：|r|n|cff00ff00点击可升级，每级提升10，当前杀怪加全属性 +%杀怪加全属性%|cff00ff00|r|n|n]]},
    ['宠物-杀怪攻击成长'] = {'杀怪攻击成长','杀怪加攻击',100,[[cwjnxx.blp]],[[|n|cffFFE799【使用说明】：|r|n|cff00ff00点击可升级，每级提升35，当前杀怪加攻击 +%杀怪加攻击%|cff00ff00|r|n|n]]},
}
...
function unit.__index:peon_add_xp(xp,reload)
    ...
    player:Map_SaveServerValue('cwjn',tonumber(self.peon_xp)) 
    -- if player.flag_peon_xp then 
    --     player:Map_AddServerValue('cwjn',tonumber(xp) or 0) --网易服务器
    -- end
