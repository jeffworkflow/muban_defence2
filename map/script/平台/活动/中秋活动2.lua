...
local function give_award(hero) 
    ...
    if rand_name == '无' then
        ...
        if value > server_value then 
            ...
            p:sendMsg('|cffebb608【系统】|r |cff00ffff'..player:get_name()..'|r |cff00ff00将骰子摇了下去，好多“四”，惊喜获得|cffff0000【可存档称谓】'..rand_name..'|r |cff00ff00称谓属性可在“最强魔灵-精彩活动”中查看',6) 
        else
            p:sendMsg('|cffebb608【系统】|r|cff00ff00未博到更高级的称谓，博了个小'..rand_name,6)  
        end    
    end    
end
