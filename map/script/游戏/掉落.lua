...
local unit_reward = {
    ...
    ['藏宝图'] =  {	
        ...
        {    rand = 2, name = '杀怪加力量+10 攻击加力量+50 每秒加力量+150' },
        {    rand = 2, name = '杀怪加敏捷+10 攻击加敏捷+50 每秒加敏捷+150',},
        {    rand = 2, name = '杀怪加智力+10 攻击加智力+50 每秒加智力+150',},
        {    rand = 2, name = '杀怪加全属性+5 攻击加全属性+25 每秒加全属性+75',},
        {    rand = 2, name = '杀怪加攻击+20 每秒加攻击+300',},
    ...
    ['羊皮纸'] =  {	
        ...
        {    rand = 1, name = '杀怪加力量+5 攻击加力量+25 每秒加力量+75' },
        {    rand = 1, name = '杀怪加敏捷+5 攻击加敏捷+25 每秒加敏捷+75',},
        {    rand = 1, name = '杀怪加智力+5 攻击加智力+25 每秒加智力+75',},
        {    rand = 1, name = '杀怪加全属性+2.5 攻击加全属性+12.5 每秒加全属性+37.5',},
        {    rand = 1, name = '杀怪加攻击+10 每秒加攻击+150',},
        {    rand = 1, name = '每秒加护甲+0.25',},
        {    rand = 1, name = '攻击减甲+2.5',},
    ...
    ['一颗神奇的种子'] =  {	
        ...
        {    rand = 1.5, name = '杀怪加力量+100 攻击加力量+500 每秒加力量+1500' },
        {    rand = 1.5, name = '杀怪加敏捷+100 攻击加敏捷+500 每秒加敏捷+1500',},
        {    rand = 1.5, name = '杀怪加智力+100 攻击加智力+500 每秒加智力+1500',},
        {    rand = 1.5, name = '杀怪加全属性+40 攻击加全属性+200 每秒加全属性+600',}, 
        {    rand = 1.5, name = '杀怪加攻击+200 每秒加攻击+3000',},
        {    rand = 1.5, name = '每秒加护甲+4',},
        {    rand = 1.5, name = '攻击减甲+50',},

        {    rand = 0.75, name = '杀怪加力量+400 攻击加力量+2000 每秒加力量+6000' },
        {    rand = 0.75, name = '杀怪加敏捷+400 攻击加敏捷+2000 每秒加敏捷+6000',},
        {    rand = 0.75, name = '杀怪加智力+400 攻击加智力+2000 每秒加智力+6000',},
        {    rand = 0.75, name = '杀怪加全属性+200 攻击加全属性+1000 每秒加全属性+3000',},
        {    rand = 0.75, name = '杀怪加攻击+800 每秒加攻击+12000',},
        {    rand = 0.75, name = '每秒加护甲+15',},
        {    rand = 0.75, name = '攻击减甲+200',},

        {    rand = 0.5, name = '暴击伤害+200%',},
        {    rand = 0.5, name = '技暴伤害+100%',},
        {    rand = 0.5, name = '会心伤害+50%',},
        {    rand = 0.5, name = '物理伤害加深+100%',},
        {    rand = 0.5, name = '技能伤害加深+50%',},
        {    rand = 0.5, name = '全伤加深+25%',},
        {    rand = 0.5, name = '对BOSS额外伤害+25%',},

        {    rand = 0.25, name = '暴击伤害+400%',},
        {    rand = 0.25, name = '技暴伤害+200%',},
        {    rand = 0.25, name = '会心伤害+100%',},
        {    rand = 0.25, name = '物理伤害加深+200%',},
        {    rand = 0.25, name = '技能伤害加深+100%',},
        {    rand = 0.25, name = '全伤加深+50%',},
        {    rand = 0.25, name = '对BOSS额外伤害+50%',},
    ...
    ['龙宫守卫'] = {{rand =0.6,name = '扭蛋券(十连抽)*1'},{rand =0.07,name = '超级扭蛋券(十连抽)*1'}},
    ...
    ['扭蛋'] = {
        ...
        {    rand = 4, name = '力量+37500' },
        {    rand = 4, name = '敏捷+37500',},
        {    rand = 4, name = '智力+37500',},
        {    rand = 4, name = '杀怪加力量+5',},
        {    rand = 4, name = '杀怪加敏捷+5',},
        {    rand = 4, name = '杀怪加智力+5',},
        {    rand = 4, name = '攻击加力量+14',},
        {    rand = 4, name = '攻击加敏捷+14',},
        {    rand = 4, name = '攻击加智力+14',},
        {    rand = 4, name = '每秒加力量+22',},
        {    rand = 4, name = '每秒加敏捷+22',},
        {    rand = 4, name = '每秒加智力+22',},

        {    rand = 0.07, name = '力量+750000' },
        {    rand = 0.07, name = '敏捷+750000',},
        {    rand = 0.07, name = '智力+750000',},
        {    rand = 0.07, name = '杀怪加力量+45',},
        {    rand = 0.07, name = '杀怪加敏捷+45',},
        {    rand = 0.07, name = '杀怪加智力+45',},
        {    rand = 0.07, name = '攻击加力量+140',},
        {    rand = 0.07, name = '攻击加敏捷+140',},
        {    rand = 0.07, name = '攻击加智力+140',},
        {    rand = 0.07, name = '每秒加力量+220',},
        {    rand = 0.07, name = '每秒加敏捷+220',},
        {    rand = 0.07, name = '每秒加智力+220',},

        {    rand = 0.007, name = '力量+7500000' },
        {    rand = 0.007, name = '敏捷+7500000',},
        {    rand = 0.007, name = '智力+7500000',},
        {    rand = 0.007, name = '杀怪加力量+450',},
        {    rand = 0.007, name = '杀怪加敏捷+450',},
        {    rand = 0.007, name = '杀怪加智力+450',},
        {    rand = 0.007, name = '攻击加力量+1400',},
        {    rand = 0.007, name = '攻击加敏捷+1400',},
        {    rand = 0.007, name = '攻击加智力+1400',},
        {    rand = 0.007, name = '每秒加力量+2200',},
        {    rand = 0.007, name = '每秒加敏捷+2200',},
        {    rand = 0.007, name = '每秒加智力+2200',},

        {    rand = 1.4, name = '攻击+900000',},
        {    rand = 1.4, name = '杀怪加攻击+22',},
        {    rand = 1.4, name = '每秒加攻击+90',},
        {    rand = 0.07, name = '攻击+4500000',},
        {    rand = 0.07, name = '杀怪加攻击+90',},
        {    rand = 0.07, name = '每秒加攻击+450',},
        {    rand = 0.007, name = '攻击+45000000',},
        {    rand = 0.007, name = '杀怪加攻击+900',},
        {    rand = 0.007, name = '每秒加攻击+4500',},

        {    rand = 1.4, name = '护甲+110',},
        {    rand = 1.4, name = '每秒加护甲+0.25',},
        {    rand = 0.07, name = '护甲+450',},
        {    rand = 0.07, name = '每秒加护甲+0.45',},
        {    rand = 0.007, name = '护甲+4500',},
        {    rand = 0.007, name = '每秒加护甲+4.5',},
    ...
    ['超级扭蛋'] = {
        ...
        {    rand = 4, name = '力量+550000' },
        {    rand = 4, name = '敏捷+550000',},
        {    rand = 4, name = '智力+550000',},
        {    rand = 4, name = '杀怪加力量+35',},
        {    rand = 4, name = '杀怪加敏捷+35',},
        {    rand = 4, name = '杀怪加智力+35',},
        {    rand = 4, name = '攻击加力量+200',},
        {    rand = 4, name = '攻击加敏捷+200',},
        {    rand = 4, name = '攻击加智力+200',},
        {    rand = 4, name = '每秒加力量+350',},
        {    rand = 4, name = '每秒加敏捷+350',},
        {    rand = 4, name = '每秒加智力+350',},

        {    rand = 0.07, name = '力量+12000000' },
        {    rand = 0.07, name = '敏捷+12000000',},
        {    rand = 0.07, name = '智力+12000000',},
        {    rand = 0.07, name = '杀怪加力量+550',},
        {    rand = 0.07, name = '杀怪加敏捷+550',},
        {    rand = 0.07, name = '杀怪加智力+550',},
        {    rand = 0.07, name = '攻击加力量+3500',},
        {    rand = 0.07, name = '攻击加敏捷+3500',},
        {    rand = 0.07, name = '攻击加智力+3500',},
        {    rand = 0.07, name = '每秒加力量+5500',},
        {    rand = 0.07, name = '每秒加敏捷+5500',},
        {    rand = 0.07, name = '每秒加智力+5500',},

        {    rand = 0.007, name = '力量+65000000' },
        {    rand = 0.007, name = '敏捷+65000000',},
        {    rand = 0.007, name = '智力+65000000',},
        ...
        {    rand = 2, name = '攻击+5500000',},
        {    rand = 2, name = '杀怪加攻击+220',},
        {    rand = 2, name = '每秒加攻击+2200',},
        {    rand = 0.07, name = '攻击+55000000',},
        {    rand = 0.07, name = '杀怪加攻击+2200',},
        {    rand = 0.07, name = '每秒加攻击+22000',},
        {    rand = 0.007, name = '攻击+350000000',},
        {    rand = 0.007, name = '杀怪加攻击+13000',},
        {    rand = 0.007, name = '每秒加攻击+130000',},

        {    rand = 2, name = '护甲+650',},
        {    rand = 2, name = '每秒加护甲+1.4',},
        {    rand = 0.07, name = '护甲+6500',},
        {    rand = 0.07, name = '每秒加护甲+14',},
