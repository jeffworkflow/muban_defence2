...
local unit_reward = {
    ...
    ['扭蛋'] = {
        ...
        {    rand = 3, name = '力量+100000' },
        {    rand = 3, name = '敏捷+100000',},
        {    rand = 3, name = '智力+100000',},
        {    rand = 3, name = '杀怪加力量+10',},
        {    rand = 3, name = '杀怪加敏捷+10',},
        {    rand = 3, name = '杀怪加智力+10',},
        {    rand = 3, name = '攻击加力量+50',},
        {    rand = 3, name = '攻击加敏捷+50',},
        {    rand = 3, name = '攻击加智力+50',},
        ...
        {    rand = 3, name = '攻击+200000',},
        {    rand = 3, name = '杀怪加攻击+20',},
        {    rand = 3, name = '每秒加攻击+200',},
    ...
    ['超级扭蛋'] = {
        ...
        {    rand = 3, name = '力量+1000000' },
        {    rand = 3, name = '敏捷+1000000',},
        {    rand = 3, name = '智力+1000000',},
        {    rand = 3, name = '杀怪加力量+50',},
        {    rand = 3, name = '杀怪加敏捷+50',},
        {    rand = 3, name = '杀怪加智力+50',},
        {    rand = 3, name = '攻击加力量+250',},
        {    rand = 3, name = '攻击加敏捷+250',},
        {    rand = 3, name = '攻击加智力+250',},
        ...
        {    rand = 3, name = '攻击+2000000',},
        {    rand = 3, name = '杀怪加攻击+100',},
        {    rand = 3, name = '每秒加攻击+1000',},
