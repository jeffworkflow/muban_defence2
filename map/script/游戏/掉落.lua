...
local unit_reward = {
    ...
    ['藏宝图'] =  {	
        ...
        {    rand = 3, name = '杀怪加力量+10 攻击加力量+50 每秒加力量+150' },
        {    rand = 3, name = '杀怪加敏捷+10 攻击加敏捷+50 每秒加敏捷+150',},
        {    rand = 3, name = '杀怪加智力+10 攻击加智力+50 每秒加智力+150',},
        {    rand = 3, name = '杀怪加全属性+5 攻击加全属性+25 每秒加全属性+75',},
        {    rand = 3, name = '杀怪加攻击+20 每秒加攻击+300',},
        {    rand = 3, name = '每秒加护甲+0.5',},
        {    rand = 3, name = '攻击减甲+5',},
