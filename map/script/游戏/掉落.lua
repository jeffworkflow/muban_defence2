...
local unit_reward = {
    ...
    ['黑暗骰子'] =  {	
        ...
        {    rand = 0.29, name = '杀敌数保本卡*1' },
        {    rand = 0.29, name = '木头保本卡*1' },
        {    rand = 0.29, name = '魔丸保本卡*1' },
        {    rand = 0.29, name = '全属性保本卡*1' },
        {    rand = 0.29, name = '杀敌数翻倍卡*1' },
        {    rand = 0.29, name = '木头翻倍卡*1' },
        {    rand = 0.29, name = '魔丸翻倍卡*1' },
        {    rand = 0.29, name = '全属性翻倍卡*1' },
        {    rand = 0.29, name = '炸弹卡*1' },
        {    rand = 0.29, name = '大炸弹卡*1' },
        {    rand = 0.29, name = '猜拳卡*1' },
        {    rand = 0.29, name = 'gg卡*1' },
