...
local unit_reward = {
    ...
    ['藏宝图'] =  {	
        {    rand = 39.59, name = '无' },
        {    rand = 9, name = '随机物品',},
        {    rand = 3.8, name = { --'随机技能' 黄：55；玄：30:；地：12；天：3
                { rand = 40, name = '黄阶'},
                { rand = 40, name = '玄阶'},
                { rand = 10, name = '地阶'},
                { rand = 10, name = '天阶'},
        }}, 
        {    rand = 3, name = '杀怪加力量+20 攻击加力量+100 每秒加力量+300' },
        {    rand = 3, name = '杀怪加敏捷+20 攻击加敏捷+100 每秒加敏捷+300',},
        {    rand = 3, name = '杀怪加智力+20 攻击加智力+100 每秒加智力+300',},
        {    rand = 3, name = '杀怪加全属性+10 攻击加全属性+50 每秒加全属性+150',},
        {    rand = 3, name = '杀怪加攻击+40 每秒加攻击+600',},
        {    rand = 3, name = '每秒加护甲+1',},
        {    rand = 3, name = '攻击减甲+15',},
        ...
        {    rand = 0.6, name = '三眼赤痕*1',}, --lv1
        {    rand = 0.6, name = '火龙气息*1',}, --lv2
        {    rand = 0.3, name = '地魂融血丹*1',}, --lv1
        {    rand = 0.3, name = '天魂融血丹*1',}, --lv2

        {    rand = 2.5, name = '强化石*1',}, --lv2
        {    rand = 0.8, name = '天谕*1',}, --lv2
    ...
    ['藏经阁小弟'] = {{rand =0.08,name = '无字天书'},{rand =0.8,name = '羊皮纸'}},
    ['藏经阁少阁主'] = {{rand =7,name = '无字天书'},{rand =93,name = '羊皮纸'}},
    ['羊皮纸'] =  {	
        {    rand = 39.94, name = '无' },
        {    rand = 12.5, name = { --'随机技能' 黄：55；玄：30:；地：12；天：3
                { rand = 50, name = '黄阶'},
                { rand = 30, name = '玄阶'},
                { rand = 15, name = '地阶'},
                { rand = 5, name = '天阶'},
