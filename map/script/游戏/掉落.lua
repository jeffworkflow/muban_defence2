...
local unit_reward = {
    ...
    ['羊皮纸'] =  {	
        ...
        {    rand = 3, name = '功法升级书*1',}, --lv2
        {    rand = 1, name = '功法连升书*1',}, --lv2
        {    rand = 0.75, name = '地魂融血丹*1',},
        {    rand = 0.75, name = '天魂融血丹*1',},
        {    rand = 1.5, name = '三眼赤痕*1',}, 
        {    rand = 1.5, name = '火龙气息*1',},
    ...
    ['剑冢小弟'] = {{rand =0.7,name = '强化石*1'},{rand =0.09,name = '天谕*1'}},
    ...
    ['百花宫宫女'] = {{rand =1.15,name = '一颗神奇的种子*1'}},
    ...
    ['一颗神奇的种子'] =  {	
        ...
        {    rand = 0.6, name = '功法升级书*1',}, --lv1
        {    rand = 0.3, name = '功法连升书*1',}, --lv2
    ...
    ['龙宫守卫'] = {{rand =1.22,name = '扭蛋券(十连抽)*1'},{rand =0.12,name = '超级扭蛋券(十连抽)*1'}},
    ['哪吒'] = {{rand =88,name = '扭蛋券(十连抽)*1'},{rand =12,name = '超级扭蛋券(十连抽)*1'}},
    ...
    ['超级扭蛋'] = {
        ...
        {    rand = 0.007, name = '攻击加力量+18000',},
        {    rand = 0.007, name = '攻击加敏捷+18000',},
        {    rand = 0.007, name = '攻击加智力+18000',},
        {    rand = 0.007, name = '每秒加力量+30000',},
        {    rand = 0.007, name = '每秒加敏捷+30000',},
        {    rand = 0.007, name = '每秒加智力+30000',},
        ...
        {    rand = 0.007, name = '攻击+300000000',},
        {    rand = 0.007, name = '杀怪加攻击+12000',},
        {    rand = 0.007, name = '每秒加攻击+120000',},
    ...
    ['黑暗骰子'] =  {	
        ...
        {    rand = 0.35, name = '杀敌数保本卡*1' },
        {    rand = 0.35, name = '木头保本卡*1' },
        {    rand = 0.35, name = '魔丸保本卡*1' },
        {    rand = 0.35, name = '全属性保本卡*1' },
        {    rand = 0.35, name = '杀敌数翻倍卡*1' },
        {    rand = 0.35, name = '木头翻倍卡*1' },
        {    rand = 0.35, name = '魔丸翻倍卡*1' },
        {    rand = 0.35, name = '全属性翻倍卡*1' },
        {    rand = 0.35, name = '炸弹卡*1' },
        {    rand = 0.35, name = '大炸弹卡*1' },
        {    rand = 0.35, name = '猜拳卡*1' },
        {    rand = 0.35, name = 'gg卡*1' },
