...
local unit_reward = {
    ...
    ['藏宝图'] =  {	
        {    rand = 57.25, name = '无' },
        {    rand = 10, name = '随机物品',},
        {    rand = 10, name = { --'随机技能' 黄：55；玄：30:；地：12；天：3
                { rand = 55, name = '黄阶'},
                { rand = 30, name = '玄阶'},
                { rand = 12, name = '地阶'},
                { rand = 3, name = '天阶'},
        }}, 
        {    rand = 1.5, name = '杀怪加力量+300 攻击加力量+1200 每秒加力量+5000' },
        {    rand = 1.5, name = '杀怪加敏捷+300 攻击加敏捷+1200 每秒加敏捷+5000',},
        {    rand = 1.5, name = '杀怪加智力+300 攻击加智力+1200 每秒加智力+5000',},
        {    rand = 1.5, name = '杀怪加全属性+150 攻击加全属性+600 每秒加全属性+2000',},
        {    rand = 1.5, name = '杀怪加攻击+600 每秒加攻击+6000',},
        ...
        --挖宝成就
        {    rand = 2, name = '黑格的陨石',}, --lv2
        {    rand = 1.5, name = '法老的遗产',}, --lv2
        {    rand = 1, name = 'ONE_PIECE',}, --lv2
        {    rand = 0.5, name = '挖宝小能手',}, --超级彩蛋
