...
--105
    ...
    ['羊皮纸'] =  {	
        {    rand = 41.24, name = '无' },
        {    rand = 12.4, name = { --'随机技能' 黄：55；玄：30:；地：12；天：3
                { rand = 50, name = '黄阶'},
                { rand = 30, name = '玄阶'},
                { rand = 15, name = '地阶'},
                { rand = 5, name = '天阶'},
    ...
    ['剑冢小弟'] = {{rand =0.04,name = '天谕*1'},{rand =0.33,name = '强化石*1'},},
    ['剑魔'] = {{rand =9,name = '天谕*1'},{rand =33,name = '强化石*1'}},
    ...
    ['一颗神奇的种子'] =  {	
        ...
        {    rand = 0.4, name = '暴击伤害+200%',},
        {    rand = 0.4, name = '技暴伤害+100%',},
        {    rand = 0.4, name = '会心伤害+50%',},
        {    rand = 0.4, name = '物理伤害加深+100%',},
        {    rand = 0.4, name = '技能伤害加深+50%',},
        {    rand = 0.4, name = '全伤加深+25%',},
        {    rand = 0.4, name = '对BOSS额外伤害+25%',},

        {    rand = 0.2, name = '暴击伤害+400%',},
        {    rand = 0.2, name = '技暴伤害+200%',},
        {    rand = 0.2, name = '会心伤害+100%',},
        {    rand = 0.2, name = '物理伤害加深+200%',},
        {    rand = 0.2, name = '技能伤害加深+100%',},
        {    rand = 0.2, name = '全伤加深+50%',},
        {    rand = 0.2, name = '对BOSS额外伤害+50%',},
