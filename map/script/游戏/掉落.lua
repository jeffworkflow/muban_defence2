...
local unit_reward = {
    ...
    ['超级藏宝图'] =  {	
        {    rand = 15, name = '无' },   
        {    rand = 15, name = { --'随机物品' 黄：55；玄：30:；地：12；天：3
                { rand = 60, name = '红'},--12
                { rand = 30, name = '黑'},--6
                { rand = 10, name = '神'},--2
        }},
...
--50
        {    rand = 4, name = '杀怪加力量+2500 攻击加力量+12500 每秒加力量+37500' },
        {    rand = 4, name = '杀怪加敏捷+2500 攻击加敏捷+12500 每秒加敏捷+37500',},
        {    rand = 4, name = '杀怪加智力+2500 攻击加智力+12500 每秒加智力+37500',},
        {    rand = 4, name = '杀怪加全属性+1250 攻击加全属性+6250 每秒加全属性+18750',},
