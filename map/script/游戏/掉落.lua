...
local unit_reward = {
    ...
    ['扭蛋'] = {
        ...
        {    rand = 0.1, name = '力量+1000000' },
        {    rand = 0.1, name = '敏捷+1000000',},
        {    rand = 0.1, name = '智力+1000000',},
        {    rand = 0.1, name = '杀怪加力量+75',},
        {    rand = 0.1, name = '杀怪加敏捷+75',},
        {    rand = 0.1, name = '杀怪加智力+75',},
        {    rand = 0.1, name = '攻击加力量+250',},
        {    rand = 0.1, name = '攻击加敏捷+250',},
        {    rand = 0.1, name = '攻击加智力+250',},
        {    rand = 0.1, name = '每秒加力量+500',},
        {    rand = 0.1, name = '每秒加敏捷+500',},
        {    rand = 0.1, name = '每秒加智力+500',},
        ...
        {    rand = 0.1, name = '杀怪加攻击+150',},
        {    rand = 0.1, name = '每秒加攻击+1000',},
    ...
    ['超级扭蛋'] = {
        ...
        {    rand = 0.1, name = '力量+10000000' },
        {    rand = 0.1, name = '敏捷+10000000',},
        {    rand = 0.1, name = '智力+10000000',},
        {    rand = 0.1, name = '杀怪加力量+500',},
        {    rand = 0.1, name = '杀怪加敏捷+500',},
        {    rand = 0.1, name = '杀怪加智力+500',},
        {    rand = 0.1, name = '攻击加力量+2500',},
        {    rand = 0.1, name = '攻击加敏捷+2500',},
        {    rand = 0.1, name = '攻击加智力+2500',},
        {    rand = 0.1, name = '每秒加力量+5000',},
        {    rand = 0.1, name = '每秒加敏捷+5000',},
        {    rand = 0.1, name = '每秒加智力+5000',},
        ...
        {    rand = 0.1, name = '攻击+20000000',},
        {    rand = 0.1, name = '杀怪加攻击+1000',},
        {    rand = 0.1, name = '每秒加攻击+10000',},
        ...
        {    rand = 0.1, name = '护甲+7500',},
        {    rand = 0.1, name = '每秒加护甲+20',},
