...
local unit_reward = {
    ...
    ['一颗神奇的种子'] =  {	
        ...
        {    rand = 0.5, name = '杀怪加力量+400 攻击加力量+2000 每秒加力量+6000' },
        {    rand = 0.5, name = '杀怪加敏捷+400 攻击加敏捷+2000 每秒加敏捷+6000',},
        {    rand = 0.5, name = '杀怪加智力+400 攻击加智力+2000 每秒加智力+6000',},
        {    rand = 0.5, name = '杀怪加全属性+200 攻击加全属性+1000 每秒加全属性+3000',},
        {    rand = 0.5, name = '杀怪加攻击+800 每秒加攻击+12000',},
        {    rand = 0.5, name = '每秒加护甲+15',},
        {    rand = 0.5, name = '攻击减甲+200',},
