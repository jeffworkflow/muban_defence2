...
mt{
   ...
   damage_area = 500,
	...
	area = 100,
	--介绍
	tip = [[|cff00bdec【主动施放】在任意位置召唤1只张全蛋为你作战，持续时间25秒

【张全蛋】属性已经在物编中写好，但需要额外增加下面属性：

        ['物品获取率'] = 英雄的物品获取率+50%*技能等级,
...
function mt:create_illusion()
    ...
    attribute['物品获取率'] = function() return hero:get('物品获取率') + 50*self.level end
