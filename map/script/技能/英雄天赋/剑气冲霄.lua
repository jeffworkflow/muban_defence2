...
mt{
  ...
  return ((self.owner:get('力量')+self.owner:get('智力')+self.owner:get('敏捷'))*12)* self.level
end,
dead_damage = function(self)
return ((self.owner:get('力量')+self.owner:get('智力')+self.owner:get('敏捷'))*13)* self.level
end,
	--施法范围
	area = 500,
	--属性加成
