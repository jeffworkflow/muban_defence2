...
mt{
   ...
   damage_area = 500,
	...
	area = 500,
	--属性加成
['生命恢复'] = {20000000,400000000},
	--介绍
	tip = [[

|cffffff00【生命恢复】+2000w*Lv|r
        
|cff00bdec【主动施放1】回复(35+1*Lv)%生命值 并每秒回复|r|cffffff006%的生命值|r |cff00bdec持续5秒|r

|cff00bdec【主动施放2】唯一技能-内伤：对周围敌人造成|r|cffffff00生命恢复效果减少(19+0.8*Lv)%|r，|cff00bdec持续5秒|r
