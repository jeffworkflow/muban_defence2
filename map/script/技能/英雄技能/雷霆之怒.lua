...
mt{
  ...
  return ((self.owner:get('力量')+self.owner:get('智力')+self.owner:get('敏捷'))*8+10000000)* self.level
end,
	--施法范围
	area = 500,
	--属性加成
