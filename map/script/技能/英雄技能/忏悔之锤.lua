...
mt{
  ...
  return ((self.owner:get('力量')+self.owner:get('智力')+self.owner:get('敏捷'))*7+10000000)* self.level
end,
	--施法范围
	area = 500,
	--属性加成
['攻击加全属性'] = {960,19200},
	--介绍
	tip = [[|cffffff00【攻击加全属性】+960*Lv

|cff00ffff【被动效果】攻击10%几率造成范围技能伤害
【伤害公式】（全属性*8+10000000）*Lv
 ]],
	--技能图标
	art = [[sqzc.blp]],
	--特效
	...
	--特效4
	effect4 = [[参考希尔瓦娜斯 山丘的大锤子，模型大小1.3，额外范围+150]],
    --移动距离
    move_distance = 200,
    max_distance = 1000,
    --投射物数量
