...
mt{
  ...
  return ((self.owner:get('力量')+self.owner:get('智力')+self.owner:get('敏捷'))*32+10000)* self.level
end,
	--施法范围
	area = 500,
	--属性加成
['杀怪加全属性'] = {80,1600},
	--介绍
	tip = [[|cffffff00【攻击加全属性】+80*Lv

|cff00ffff【被动效果】攻击10%几率造成范围技能伤害
【伤害公式】（全属性*32+10000）*Lv]],
	--技能图标
	art = [[longxiaojiutian.blp]],
	--特效
	effect = [[0007788 (2).mdx]],
	--特效4
	effect4 = [[类似希尔瓦娜斯的巨浪，移动距离1500]],
	--范围
	distance = 1500,
	hit_area = 125,
	--概率%
