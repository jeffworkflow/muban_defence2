...
mt{
  ...
  return ((self.owner:get('力量')+self.owner:get('智力')+self.owner:get('敏捷'))*20+100000000)* self.level
end,
	--施法范围
	area = 500,
	--属性加成
['每秒加全属性'] = {3200,64000},
	--介绍
	tip = [[|cffffff00【每秒加全属性】+3200*Lv

|cff00ffff【被动效果】攻击10%几率造成范围技能伤害
【伤害公式】（全属性*32+100000000）*Lv]],
	--技能图标
	art = [[xcff.blp]],
	--特效
	effect = [[eff.MDX]],
