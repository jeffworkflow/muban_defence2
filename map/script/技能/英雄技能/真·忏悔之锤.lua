...
mt{
  ...
  return ((self.owner:get('力量')+self.owner:get('智力')+self.owner:get('敏捷'))*8+100000000)* self.level
end,
	--施法范围
	area = 500,
	--属性加成
...
【伤害公式】（全属性*10+100000000）*Lv
	...
	--特效4
	effect4 = [[参考希尔瓦娜斯 山丘的大锤子，模型大小1.3，额外范围+150，投射物=2]],
    --移动距离
    move_distance = 200,
    max_distance = 1000,
    --投射物数量
