...
mt{
    ...
    on_add_tip = [[]],
     --提示的tip
    send_tip = [[|cffffe799【系统消息】|r 恭喜获得隐藏羁绊技能|cffff0000 "赤灵传奇" |r，|cff00ff00全属性+500万，物品获取率+35%，杀敌数加成+35%，木头加成+35%，魔丸加成+35%|r]]
}
...
mt{
    ...
    on_add_tip = [[]],
    --发送给全部玩家的tip
    send_tip =[[|cffffe799【系统消息】|r 恭喜获得隐藏羁绊技能|cffff0000 "为爆炸而生" |r，|cff00ff00暴击几率+5%,暴击伤害+200%，技暴几率+10%,技暴伤害+100%|r]],
}
...
mt{
    ...
    on_add_tip = [[]],
    --发送给全部玩家的tip
    send_tip =[[|cffffe799【系统消息】|r 恭喜获得隐藏羁绊技能|cffff0000 "冰火三重天" |r，|cff00ff00技暴几率+10%，技暴伤害+100%，技能伤害加深+20%|r]],
}
