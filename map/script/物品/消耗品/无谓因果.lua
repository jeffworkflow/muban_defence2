        ...
        self.dialog = create_dialog(player,'请选择要吞噬的技能',list,function (index)
            ...
            if skill then 
                ...
                if player.ruti_cnt  == 8 then 
                    ...
                    ac.player.self:sendMsg('|cffffe799【系统消息】|r|cff00ffff'..player:get_name()..'|r|cff00ffff 不断食用'..self:get_title()..'|r 惊喜获得技能|cffff0000 "不惧轮回" |r |cff00ff00每5秒触发一次，对周围敌人造成全属性*200的伤害，并晕眩1秒|r',6)
                end   
