...
function mt:add_content()
    ...
    --发送消息
    if flag then 
        tran_player:sendMsg('|cffebb608【系统】|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r解密过程中，一阵醍醐灌顶，获得 |cffff0000'..rand_name..'|r',2)
    end  
    ...
    for k,v in rand_name:gmatch '(%S+)%*(%d+%s-)' do
        ...
        if finds(k,'熔炼石')  then
            if not p.flag_ypz[k] then  
                ...
                p.flag_ypz[k] = true
                tran_player:sendMsg('|cffebb608【系统】|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，原来它是 |cffff0000'..(it.color_name or it.name)..'|r',2)
            else
                print('重新再随机一次',k)
                self:add_content()
                return
    ...
    elseif  rand_name == '随机物品' then
        ...
        tran_player:sendMsg('|cffebb608【系统】|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，原来它是 |cff'..ac.color_code[lni_color]..name..'|r',2)
    elseif  finds(rand_name,'天阶','地阶','玄阶','黄阶') then
        ...
        tran_player:sendMsg('|cffebb608【系统】|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，原来它是 |cff'..ac.color_code[color or '白']..'【技能书】'..name..'|r',2)
    elseif  rand_name == '魔丸' then
        self.owner:add_rec_ex(10000)
        tran_player:sendMsg('|cffebb608【系统】|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，原来它是 |cffff0000'..rand_name..'+10000|r',2) 
    elseif  rand_name == '木头' then
        self.owner:add_wood(3500)
        tran_player:sendMsg('|cffebb608【系统】|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，原来它是 |cffff0000'..rand_name..'+3500|r',2) 
    ...
    elseif finds(rand_name,'百佛图') then
        ...
        if not skl  then 
            ...
            --给全部玩家发送消息
            ac.player.self:sendMsg('|cffebb608【系统】|r|cffff0000运气暴涨!!!|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，惊喜获得 |cffff0000'..rand_name..' |r ,奖励 |cffff0000全属性+150万，生命上限+5%，护甲+1500',6)
            ac.player.self:sendMsg('|cffebb608【系统】|r|cffff0000运气暴涨!!!|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，惊喜获得 |cffff0000'..rand_name..' |r ,奖励 |cffff0000全属性+150万，生命上限+5%，护甲+1500',6)
            ac.player.self:sendMsg('|cffebb608【系统】|r|cffff0000运气暴涨!!!|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，惊喜获得 |cffff0000'..rand_name..' |r ,奖励 |cffff0000全属性+150万，生命上限+5%，护甲+1500',6)
        else
    ...
    elseif finds(rand_name,'洗髓经') then
        ...
        if not skl  then 
            ...
            local tip = tran_space(new_skl:get_tip()) --去除换行为空格
            --给全部玩家发送消息
            ac.player.self:sendMsg('|cffebb608【系统】|r|cffff0000运气暴涨!!!|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，惊喜获得 |cffff0000'..rand_name..' |r，奖励 |cffff0000全属性+300万，减伤+5%， 每秒回血+5%',6)
            ac.player.self:sendMsg('|cffebb608【系统】|r|cffff0000运气暴涨!!!|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，惊喜获得 |cffff0000'..rand_name..' |r，奖励 |cffff0000全属性+300万，减伤+5%， 每秒回血+5%',6)
            ac.player.self:sendMsg('|cffebb608【系统】|r|cffff0000运气暴涨!!!|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，惊喜获得 |cffff0000'..rand_name..' |r，奖励 |cffff0000全属性+300万，减伤+5%， 每秒回血+5%',6)
        else
            self:add_content() --已挖到再随机一次
    ...
    elseif finds(rand_name,'易筋经') then
        ...
        if not skl  then 
            ...
            local tip = tran_space(new_skl:get_tip()) --去除换行为空格
            --给全部玩家发送消息
            ac.player.self:sendMsg('|cffebb608【系统】|r|cffff0000运气暴涨!!!|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，惊喜获得 |cffff0000'..rand_name..' |r，奖励 |cffff0000全属性+600万，免伤几率5%， 闪避+5%',6)
            ac.player.self:sendMsg('|cffebb608【系统】|r|cffff0000运气暴涨!!!|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，惊喜获得 |cffff0000'..rand_name..' |r，奖励 |cffff0000全属性+600万，免伤几率5%， 闪避+5%',6)
            ac.player.self:sendMsg('|cffebb608【系统】|r|cffff0000运气暴涨!!!|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，惊喜获得 |cffff0000'..rand_name..' |r，奖励 |cffff0000全属性+600万，免伤几率5%， 闪避+5%',6)
        else
            self:add_content() --已挖到再随机一次
    ...
    elseif finds(rand_name,'天诀') then
        ...
        if not skl  then 
            ...
            local tip = tran_space(new_skl:get_tip()) --去除换行为空格
            --给全部玩家发送消息
            ac.player.self:sendMsg('|cffebb608【系统】|r|cffff0000运气暴涨!!!|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，惊喜获得 |cffff0000'..rand_name..' |r，奖励 |cffff0000全属性+1200万， 技暴几率+5%， 技暴伤害+100%， 技能伤害加深+50%， 对BOSS额外伤害+15%，',6)
            ac.player.self:sendMsg('|cffebb608【系统】|r|cffff0000运气暴涨!!!|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，惊喜获得 |cffff0000'..rand_name..' |r，奖励 |cffff0000全属性+1200万， 技暴几率+5%， 技暴伤害+100%， 技能伤害加深+50%， 对BOSS额外伤害+15%，',6)
            ac.player.self:sendMsg('|cffebb608【系统】|r|cffff0000运气暴涨!!!|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，惊喜获得 |cffff0000'..rand_name..' |r，奖励 |cffff0000全属性+1200万， 技暴几率+5%， 技暴伤害+100%， 技能伤害加深+50%， 对BOSS额外伤害+15%，',6)
        else
            self:add_content() --已挖到再随机一次
    ...
    elseif finds(rand_name,'鉴宝大师') then
        ...
        if not skl  then 
            ...
            local tip = tran_space(new_skl:get_tip()) --去除换行为空格
            --给全部玩家发送消息
            ac.player.self:sendMsg('|cffebb608【系统】|r|cffff0000运气暴涨!!!|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，惊喜获得 |cffff0000'..rand_name..' |r，奖励 |cffff00001800万全属性，魔丸+25W，每秒加魔丸+75，魔丸加成+75%|r',6)
            ac.player.self:sendMsg('|cffebb608【系统】|r|cffff0000运气暴涨!!!|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，惊喜获得 |cffff0000'..rand_name..' |r，奖励 |cffff00001800万全属性，魔丸+25W，每秒加魔丸+75，魔丸加成+75%|r',6)
            ac.player.self:sendMsg('|cffebb608【系统】|r|cffff0000运气暴涨!!!|r |cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'|r进行解密，惊喜获得 |cffff0000'..rand_name..' |r，奖励 |cffff00001800万全属性，魔丸+25W，每秒加魔丸+75，魔丸加成+75%|r',6)
        else
            self:add_content() --已挖到再随机一次
    ...
    elseif rand_name == '书呆子' then
        ...
        if ac.g_game_degree_attr > p:Map_GetServerValue(key) then 
            ...
            if not skl  then 
                ...
                ac.player.self:sendMsg('|cffebb608【系统】|r|cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'进行解密|r 惊喜获得 |cffff0000【可存档成就】'..rand_name..'|r 属性可在最强魔灵-隐藏成就中查看',6)
                ac.player.self:sendMsg('|cffebb608【系统】|r|cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'进行解密|r 惊喜获得 |cffff0000【可存档成就】'..rand_name..'|r 属性可在最强魔灵-隐藏成就中查看',6)
                ac.player.self:sendMsg('|cffebb608【系统】|r|cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'进行解密|r 惊喜获得 |cffff0000【可存档成就】'..rand_name..'|r 属性可在最强魔灵-隐藏成就中查看',6)
            else 
                skl:upgrade(1)  
                ac.player.self:sendMsg('|cffebb608【系统】|r|cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'进行解密|r |cffff0000【可存档成就】'..rand_name..'获得升级|r 升级后的属性可在最强魔灵-隐藏成就中查看',6)
                ac.player.self:sendMsg('|cffebb608【系统】|r|cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'进行解密|r |cffff0000【可存档成就】'..rand_name..'获得升级|r 升级后的属性可在最强魔灵-隐藏成就中查看',6)
                ac.player.self:sendMsg('|cffebb608【系统】|r|cff00ffff'..player:get_name()..'|r 对|cff00ff00'..self.name..'进行解密|r |cffff0000【可存档成就】'..rand_name..'获得升级|r 升级后的属性可在最强魔灵-隐藏成就中查看',6)
            end   
        else 
