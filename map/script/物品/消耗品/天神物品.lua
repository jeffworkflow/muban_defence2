...
|cffFFE799【神器属性】：|r
+%杀怪加力量% 杀怪加力量
+%每秒加木头% |cffffe799%|r 每秒加木头
+%物理伤害加深% |cffffe799%|r 物理伤害加深
 ]],
}

local mt = ac.skill['龙皇之心']
mt{
--图标
art = "tianshen2.blp",
-- extr_tip = '\n|cffffff00点击对【太初锁灵鼓】进行存档，存档后可在最强魔灵-成神中查看',
...
|cffFFE799【神器属性】：|r
+%杀怪加攻击% 杀怪加攻击
+%每秒加全属性% |cffffe799%|r 每秒加全属性
+%全伤加深% |cffffe799%|r 全伤加深
 ]],
}

local mt = ac.skill['封神结']
mt{
--图标
art = "tianshen3.blp",
-- extr_tip = '\n|cffffff00点击对【太初锁灵鼓】进行存档，存档后可在最强魔灵-成神中查看',
...
|cffFFE799【神器属性】：|r
+%杀怪加生命上限% 杀怪加生命上限
+%每秒加杀敌数% |cffffe799%|r 每秒加杀敌数
+%减少周围护甲% 减少周围护甲
 ]],
}

local mt = ac.skill['烟月神镜']
mt{
--图标
art = "tianshen4.blp",
-- extr_tip = '\n|cffffff00点击对【太初锁灵鼓】进行存档，存档后可在最强魔灵-成神中查看',
...
|cffFFE799【神器属性】：|r
+%杀怪加智力% 杀怪加智力
+%每秒加魔丸% |cffffe799%|r 每秒加魔丸
+%技能伤害加深% |cffffe799%|r 技能伤害加深
 ]],
}

local mt = ac.skill['天星奇光镯']
mt{
--图标
art = "tianshen5.blp",
-- extr_tip = '\n|cffffff00点击对【太初锁灵鼓】进行存档，存档后可在最强魔灵-成神中查看',
...
|cffFFE799【神器属性】：|r
+%杀怪加敏捷% 杀怪加敏捷
+%每秒加护甲% |cffffe799%|r 每秒加护甲
+%攻击减甲% 攻击减甲
 ]],
}
-- 神器
local magic_item = {
    '番天印','战舰之舵','量天尺','虚空王座','天眼','血羽之心','天神之息','灭世者','宇宙之心','太初锁灵鼓','晨钟暮鼓','龙皇之心','封神结','烟月神镜','天星奇光镯'
}
