                ...
                player:event '玩家-注册英雄后'(function()
                    ...
                    function mt:on_change_creep(unit,lni_data)
                        ...
                        unit:event '单位-死亡'(function(_,unit,killer)
                            ...
                            local max_cnt = math.min((p.kangfu_cnt[skl_color] or 1)*50,350)
                            p.kangfu[skl_color] = (p.kangfu[skl_color] or 0) +1

                            if p.kangfu[skl_color] % per_cnt == 0 then 
                                p:sendMsg('|cffebb608【系统】|r|cff00ff00当前击杀|cffffff00'..skl_color..'功法怪|cff00ff00进度 |cffffff00'..p.kangfu[skl_color]..'/'..max_cnt,5)
                            end    
                            if p.kangfu[skl_color]  == max_cnt then 
                                p:sendMsg('|cffebb608【系统】|r |cff'..ac.color_code[skl_color]..skl_color..'功法 |cff00ff00掉落在练功房的地板上,请尽快拾取',5)
