...
cool = function(self)
    ...
    return 180 * (1-p:get('挑战商店cd减少百分比')/100)
end,
init_cd = 4,
...
cool = function(self)
    local p = self.owner.owner
    return 210 * (1-p:get('挑战商店cd减少百分比')/100)
end,
init_cd = 120,
ignore_cool_save = true,
unit_name ='梦魇',
...
ac.game:event '游戏-回合开始'(function(trg,index, creep) 
    ...
    local shop = ac.shop.create('世界BOSS',x,y,270)
    for i,name in ipairs({'召唤团队BOSS【肉山】','召唤团队BOSS【梦魇】','召唤团队BOSS【戈登的激情】','召唤团队BOSS【火焰领主】','召唤团队BOSS【毁灭者】'}) do 
