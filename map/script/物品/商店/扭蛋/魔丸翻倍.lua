...
--说明
tip = [[|cffFFE799【说明】|r（|cff00ffff当前魔丸:|r%has_vale%）
...
--     mt.player_fire[ac.player.self] = ac.player.self.rec_ex    
...
--     end
--     ac.loop(1000,function() 
--         shop_item.player_fire[ac.player.self] = ac.player.self.rec_ex    
--         -- print('木头翻倍',ac.player.self.kill_count)
--     end)  
-- end    
