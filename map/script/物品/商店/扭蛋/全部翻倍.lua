...
|cff00ff0050%杀敌数/木头/魔丸|cff00ff00翻倍|r  |cffff000050%杀敌数/木头/魔丸|cffff0000归零|r
]],
has_vale = function() 
...
function mt:on_cast_start()
    ...
    if rec_ex <=10 and wood <=10  and kill_count <=10 then 
    ...
    local hero = p.hero
    local rate = 7.5
    if rec_ex >= 90000 or wood >=30000 or kill_count >=10000 then 
