...
ac.item.suit = {
    ...
    {'【雅典娜】','雅典娜的赠礼','智力','3 技暴几率+7.5% 技暴伤害+75% ','5 技暴几率+7.5% 技暴伤害+75%' },
    {'【安泰】','安泰的赠礼','力量','3 暴击几率+10% 暴击伤害+100% 物理伤害加深+50%','5 暴击几率+10% 暴击伤害+100% 物理伤害加深+50%' },
    {'【闪电侠】','闪电侠的赠礼','敏捷','3 攻击间隔-0.125 ','5 攻击间隔-0.125' },
    {'【不死鸟】','不死鸟的赠礼','护甲','3 减伤+12.5% 每秒加护甲+5','5 减伤+12.5% 每秒加护甲+5' },
    {'【海贼王】','海贼王的赠礼','收益','3 物品获取率+30% 木头加成+30% 杀敌数加成+30% 魔丸加成+30% ','5 物品获取率+30% 木头加成+30% 杀敌数加成+30% 魔丸加成+30% ' },
