...
ac.item.suit = {
    ...
    {'【吉安娜】','吉安娜的赠礼','智力','3 技暴几率+10% 技暴伤害+200% 杀怪加智力+2000','5 技暴几率+10% 技暴伤害+200% 杀怪加智力+2000' },
    {'【野蛮人】','野蛮人的赠礼','力量','3 暴击几率+10% 暴击伤害+400% 物理伤害加深+125%','5 暴击几率+10% 暴击伤害+400% 物理伤害加深+125%' },
    {'【迅猛龙】','迅猛龙的赠礼','敏捷','3 分裂伤害+50% 攻击间隔-0.1 攻击加全属性+10000','5 分裂伤害+50% 攻击间隔-0.1 攻击加全属性+10000' },
    {'【守护神】','守护神的赠礼','护甲','3 减伤+7.5% 每秒加护甲+10 减少周围护甲+1000','5 减伤+7.5% 每秒加护甲+10 减少周围护甲+1000' },
    {'【掠夺者】','掠夺者的赠礼','收益','3 物品获取率+25% 木头加成+25% 杀敌数加成+25% 魔丸加成+25% ','5 物品获取率+25% 木头加成+25% 杀敌数加成+25% 魔丸加成+25% ' },
    {'【食人魔】','食人魔的赠礼','减甲','3 吸血+25% 攻击速度+100% 攻击减甲+200 ','5 吸血+25% 攻击速度+100% 攻击减甲+200 ' },
}
