...
ac.item.suit = {
    ...
    {'【大天使】','大天使的赠礼','全属性','3 全伤加深+25% 杀怪加全属性+1000','5 全伤加深+25% 杀怪加全属性+1000'},
    {'【吉安娜】','吉安娜的赠礼','智力','3 技暴几率+10% 技暴伤害+200% ','5 技暴几率+10% 技暴伤害+200%' },
    {'【野蛮人】','野蛮人的赠礼','力量','3 暴击几率+10% 暴击伤害+200% 物理伤害加深+50%','5 暴击几率+10% 暴击伤害+200% 物理伤害加深+50%' },
    {'【迅猛龙】','迅猛龙的赠礼','敏捷','3 攻击间隔-0.125 ','5 攻击间隔-0.125' },
    {'【守护神】','守护神的赠礼','护甲','3 减伤+12.5% 每秒加护甲+10','5 减伤+12.5% 每秒加护甲+10' },
    {'【掠夺者】','掠夺者的赠礼','收益','3 物品获取率+35% 木头加成+35% 杀敌数加成+35% 魔丸加成+35% ','5 物品获取率+35% 木头加成+35% 杀敌数加成+35% 魔丸加成+35% ' },
    {'【食人魔】','食人魔的赠礼','减甲','3 吸血+20% 攻击减甲+75 减少周围护甲+750 ','5 吸血+20% 攻击减甲+75 减少周围护甲+750 ' },
}
