...
v2 = {5,8},
	--介绍
	tip = [[|cffcccccc用反光材料制成的斧头，能够混淆敌军。

|cffffff00+%力量%|r 力量
|cffffff00+%移动速度%|r 移动速度
|cffffff00+%物理伤害加深%|r 物理伤害加深

|cffffff00【被动-幻影】|r攻击 %v1% %几率召唤一个的镜像（强度和物品等级相关），持续 %v2%S]],
	--备注
	effect4 = [[参考技能“不朽镜像”
攻击、护甲、生命上限继承公式：0.8+0.08*Lv
其它属性=英雄]],
	--业务技能代码
}
...
function mt:damage_start(damage)
	self.value = 0.8+0.08*self.level
    self.time = self.v2
    local skill = self
