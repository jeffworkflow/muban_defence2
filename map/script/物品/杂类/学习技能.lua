    ...
    if #list < self.skill_cnt then 
        ...
        if #list == self.skill_cnt - 1 then 
            ...
            if not skl  then 
                ...
                --给全部玩家发送消息
                ac.player.self:sendMsg('|cffffe799【系统消息】|r|cff00ffff'..player:get_name()..'|r获得成就|cffff0000 "八个技能的男人" |r 奖励 |cffff0000全属性+100w，魔丸加成+15%，攻击减甲+15|r |cff00ff00 Ps:当功法学满后，点击新的功法书|cffffff00可替换|cff00ff00身上的功法，且|cffffff00功法等级可被继承|r',5)
